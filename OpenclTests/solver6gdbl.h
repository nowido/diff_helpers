...
struct Solver
{
    ...
    cl_mem workspace;   // double (fp64) resource
    ...
    bool Init(size_t useDimension, ClPlayground* useCl, fn_cl_notify notify = NULL)
    {
        ...
        program = cl->PrepareProgram(dev, devco, "#include \"kern_eliminator6gdbl.cl\"");
        ...
        workspace = clCreateBuffer(devco, CL_MEM_READ_WRITE, fp64ResourceSize, NULL, &errcode);    
    ...
    void useMatrix(double* argMatrix)
    {
        ...
        double* mappedWorkspace = (double*)clEnqueueMapBuffer
        (
            cmd, 
            workspace, 
            CL_TRUE, 
    ...
    bool Solve()
    {
        ...
        clSetKernelArg(eliminatorKernel, 3, groupSizeX * sizeof(double), NULL);    
        clSetKernelArg(eliminatorKernel, 4, groupSizeY * sizeof(double), NULL);    
        ...
        {         
            ...
            mappedBuffer = (double*)clEnqueueMapBuffer
                                    (
                                        cmd, 
                                        workspace, 
                                        CL_TRUE, 
                                        CL_MAP_READ, 
                                        mapOffset * sizeof(double), 
                                        mapSize * sizeof(double), 
                                        0, 
                                        NULL, 
                                        NULL, 
                                        &errcode
            ...
            if(workSize[0] > 0)
            {
                ...
                clSetKernelArg(rowDivideKernel, 0, sizeof(double), &pivotElement);
        ...
        mappedBuffer = (double*)clEnqueueMapBuffer(cmd, workspace, CL_TRUE, CL_MAP_READ, 0, fp64ResourceSize, 0, NULL, NULL, &errcode);
...
private:
    ...
    {
        double* m = (double*)clEnqueueMapBuffer
                                (
                                    cmd, 
                                    workspace, 
                                    CL_TRUE, 
