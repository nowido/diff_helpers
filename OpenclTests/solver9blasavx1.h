...
struct TiledMatrix
{
    ...
    /////////////////////////////////////////
    void swapRowsInPanel(size_t panelDiagIndex, size_t r1, size_t r2)
    {
        size_t vertIndex1 = r1 / tileRows;
        size_t vertIndex2 = r2 / tileRows;
        ...
        size_t index1 = vertIndex1 * tilesCountHoriz + panelDiagIndex;
        size_t index2 = vertIndex2 * tilesCountHoriz + panelDiagIndex;

        if(vertIndex1 != vertIndex2)
        {
            swapRowsInPanelFromDifferentTiles(panelDiagIndex, tiles[index1], tiles[index2], inTileR1, inTileR2);
        }
        else
        {
            tiles[index1]->swapRows(inTileR1, inTileR2);
        }
    }    
...
private:
    ...
    /////////////////////////////////////////
    void swapRowsInPanelFromDifferentTiles(Tile* t1, Tile* t2, size_t r1, size_t r2)
    {
